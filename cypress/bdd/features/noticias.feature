Feature: Efeito hover em imagens de noticias - Dados Invalidos e Inoportunos
  ...
  Scenario: Hover em viewport mobile nao deve quebrar o layout
  ...
  Scenario: Hover em imagem com src invalido nao deve gerar erro
  ...
  Scenario: Hover disparado antes do carregamento completo nao deve causar falha
  ...
  Scenario: Hover em container sem imagem filha nao deve gerar excecao
  ...
  Scenario: Hover repetido em alta frequencia nao deve travar o layout
