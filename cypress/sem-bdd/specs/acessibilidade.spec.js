...
describe('Acessibilidade - Site do Inatel', () => {
  ...
  it('TC-001 - deve abrir o gerenciador de acessibilidade com os controles principais', () => {
  ...
  it('TC-002 - deve aplicar contraste escuro no html', () => {
  ...
  it('TC-003 - deve aplicar contraste claro e contraste cinza de forma independente', () => {
  ...
  it('TC-004 - deve aumentar o tamanho base da fonte', () => {
  ...
  it('TC-005 - deve reduzir o tamanho base da fonte apos um aumento', () => {
    acessibilidadePage.clicarOpcaoPorSeletor(acessibilidadePage.seletores.opcaoAumentarFonte)
  ...
  it('TC-006 - deve combinar aumento de fonte com contraste escuro', () => {
    acessibilidadePage.capturarFontSizeRaizInline('fontAntes')
    acessibilidadePage.capturarNivelFonte('nivelAntes')
  ...
  it('TC-007 - deve ativar zoom ao passar o mouse e exibir tooltip', () => {
    cy.get('body').then(($body) => {
  ...
  it('TC-008 - deve abrir o gerenciador de cookies a partir do modal de acessibilidade', () => {
